    ...
    <div class="container mx-auto pt-4 pb-12">
      <div class="carousel relative shadow-2xl bg-white">
        <div class="carousel-inner relative overflow-hidden w-full">
          ...
          <label for="carousel-1" class="prev control-2 w-10 h-10 ml-2 md:ml-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white bg-white leading-tight text-center z-10 inset-y-0 left-0 mt-auto">‹</label>
          <label for="carousel-3" class="next control-2 w-10 h-10 ml-48 md:ml-48 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white bg-white leading-tight text-center z-10 inset-y-0 left-0 mt-auto">›</label> 
          ...
          <label for="carousel-2" class="prev control-3 w-10 h-10 ml-2 md:ml-10 absolute cursor-pointer hidden text-3xl font-bold text-black hover:text-white bg-white leading-tight text-center z-10 inset-y-0 left-0 mt-auto">‹</label>
